                ...
                <div className="m-auto max-w-6xl p-2 md:p-12 h-5/6" id='about' >
                    ...
                    <div className="flex flex-col-reverse lg:flex-row py-8 justify-between lg:text-left font-poppins" data-aos="fade-up">
                        ...
                        <div className="flex-col my-4 text-center lg:text-left lg:my-0 lg:justify-end w-full lg:w-1/2 px-8" data-aos="zoom-in" data-aos-delay="500">
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-Regular'>Strategy Development: Custom plans for social media growth and engagement.</p>
                            </div>
                            ...
                            <div>
                                <p className='my-3 text-xl text-gray-600 font-Regular'>Performance Tracking: Regular reports to ensure growth and success.</p>
                            </div>
