...
const Contact = () => {
    useDocTitle('Scoopy - Send us a message')
    ...
    return (
        <>
            ...
            <div id='contact' className="flex justify-center items-center mt-8 w-full py-12 lg:py-24 ">
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">

                <form onSubmit={sendEmail}>

                    <div className="w-full bg-gray-300 p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
                        <div className="flex">
                ...
                <div className="w-full  lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-yellow-500 rounded-2xl">
                        <div className="flex flex-col text-white">     
                            <div className="flex my-4 w-2/3 lg:w-3/4">
                                ...
                                <div className="flex flex-col">
                                <h2 className="text-2xl text-black">Office Address</h2>
                                    <p className="text-black-400">403, Cross Cut Road, Gandhipuram, Coimbatore
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="text-black-400">+91 99942 41776
                                    </p>
                                    <p className="text-black-400">+91 90035 76179
                                    </p>
                                    <p className="text-black-400">+91 9894828934
                                    </p>
                                
                                    <div className='mt-5'>
                                        <h2 className="text-2xl text-black">Send an E-mail</h2>
                                        <p className="text-black-400">scoopydigital@gmail.com </p>
                                    </div>
